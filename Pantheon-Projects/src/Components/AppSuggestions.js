...
function AppSuggestions() {
    ...
    useEffect(() => {
        Axios
            .get("http://localhost:3006/appSuggestions")
    ...
    let newarray = appsuggestions.sort((a, b) => (a.rank < b.rank) ? 1 : (a.rank === b.rank) ? 1 : -1)
    let i = 0;

    return (
        <div>
            <p className="headerapp">App Suggestions</p>
                                        ...
                                        if (appprogress.id === app.id) {
                                            if (appprogress.progress < 0) {
                                                return (
                                                    ...
                                                    <div className="div-red" key={app.id}> <p>{app.progress}</p>
                                                        <div></div>
                                                    </div>
